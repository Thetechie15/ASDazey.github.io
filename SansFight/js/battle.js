...
function toPap() {
    document.getElementById('sans').src = "img/pap.png";
    document.getElementById('bgm1').src = "audio/pap.ogg";
    document.getElementById('se_sans').src = "audio/papyrus.ogg";
...
function toSans() {
    ...
    document.getElementById('bgm1').src = "audio/megalovania.ogg";
    document.getElementById('se_sans').src = "audio/sans.ogg";
    //document.getElementById('').src = "";
    //document.getElementById('').src = "";
    //document.getElementById('').src = "";
}
...
BattleScene.prototype.resetGame = function(diff_level) {
	...
	switch (diff_level) {
		...
		case "hard":
			heart.tolerance = 2;
			this.play_speed = 1.5;
			document.getElementById("love").innerHTML = "19";
			toSans();
			break;
		case "pap":
		  heart.tolerance = 1;
			this.play_speed = 1;
			document.getElementById("love").innerHTML = "8";
			toPap();
			break;
	}
